...
!EOP
    ...
    call ESMF_ConfigFindLabel(LIS_config, "Noah-MP.3.6 number of snow layers:", rc = rc)
    do n=1, LIS_rc%nnest
        call ESMF_ConfigGetAttribute(LIS_config, NOAHMP36_struc(n)%nsnow, rc=rc)
        call LIS_verify(rc, "Noah-MP.3.6 number of snow layers: not defined")
    enddo

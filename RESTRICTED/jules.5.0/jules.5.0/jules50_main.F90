...
!BOP
!
! !ROUTINE: jules50_main
! \label{jules50_main}
!
! !ROUTINE: jules50_main.F90
! 
! !INTERFACE:
subroutine jules50_main(n)
...
! !DESCRIPTION:
!
!  Calls the run routines for the forcing-only option (jules50)
!
!  The arguments are:
!  \begin{description}
!  \item[n]
...
!EOP
   ...
   logical         :: get_forcing
   real            :: lw_upward, trad, snow_frac, albedo_land, prcp, smc_liq, smc_ice
         ...
         do
            ...
            do t=start_k, end_k
               if ( LIS_surface(n,LIS_rc%lsm_index)%tile(t)%ensem == m ) then
                 ...
                 jules50_struc(n)%jules50(t)%frac(pft) = LIS_surface(n,LIS_rc%lsm_index)%tile(t)%fgrd
                 tstar_box=tstar_box+jules50_struc(n)%jules50(t)%frac(pft)*jules50_struc(n)%jules50(t)%tstar_tile(pft)
               endif
            enddo
            ...
            do t=start_k, end_k
               if ( LIS_surface(n,LIS_rc%lsm_index)%tile(t)%ensem == m ) then
                  pft = jules50_struc(n)%jules50(t)%pft 
                  jules50_struc(n)%jules50(t)%frac(pft) = LIS_surface(n,LIS_rc%lsm_index)%tile(t)%fgrd
                  jules50_struc(n)%jules50(t)%land_mask = .true.
                  jules50_struc(n)%jules50(t)%z1_tq = jules50_struc(n)%z1_tq
                  jules50_struc(n)%jules50(t)%z1_uv = jules50_struc(n)%z1_uv

                  jules50_struc(n)%jules50(t)%tstar=tstar_box
               ...
               if ( LIS_surface(n,LIS_rc%lsm_index)%tile(t)%ensem == m ) then
                  ...
                  do i=1, jules50_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n, t,         &
                        LIS_MOC_SOILTEMP,                            &
                        value=jules50_struc(n)%jules50(t)%t_soil(i), &
...
!                  do i=1, jules50_struc(n)%sm_levels
!                     smc_liq = jules50_struc(n)%jules50(t)%p_s_sthu(i) * jules50_struc(n)%jules50(t)%p_s_smvcst(i) 
!                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
!                        LIS_MOC_SMLIQFRAC,                            &
!                        value=smc_liq, &
!                        vlevel=i, unit="m^3 m-3", direction="-",             &
...
!                        surface_type=LIS_rc%lsm_index)
!                  enddo
!                  ! relatieve fraction, unfrozen (liquid) soil moisture 
!                  do i=1, jules50_struc(n)%sm_levels
!                     smc_liq = jules50_struc(n)%jules50(t)%p_s_sthu(i)/(jules50_struc(n)%jules50(t)%p_s_sthu(i)+jules50_struc(n)%jules50(t)%p_s_sthf(i))
!                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
!                        LIS_MOC_SMLIQFRAC,                            &
!                        value=smc_liq, &
...
!                  do i=1, jules50_struc(n)%sm_levels
!                     smc_ice = jules50_struc(n)%jules50(t)%p_s_sthf(i) * jules50_struc(n)%jules50(t)%p_s_smvcst(i) 
!                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
!                        LIS_MOC_SMFROZFRAC,                            &
!                        value=smc_ice, &
!                        vlevel=i, unit="m^3 m-3", direction="-",             &
...
!                        surface_type=LIS_rc%lsm_index)
!                  enddo
!                  ! relatieve fraction, frozen (ice) soil moisture 
!                  do i=1, jules50_struc(n)%sm_levels
!                     smc_ice = jules50_struc(n)%jules50(t)%p_s_sthf(i)/(jules50_struc(n)%jules50(t)%p_s_sthu(i)+jules50_struc(n)%jules50(t)%p_s_sthf(i))
!                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
!                        LIS_MOC_SMFROZFRAC,                            &
!                        value=smc_ice, &
!                        vlevel=i, unit="-", direction="-",             &
...
!                  enddo
                  ...
                  do i=1, jules50_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
                        LIS_MOC_JULES_STHU,                            &
                        value=jules50_struc(n)%jules50(t)%p_s_sthu(i), &
                        vlevel=i, unit="-", direction="-",             &
                        valid_min=0.0, valid_max=1.0,                  &
                        surface_type=LIS_rc%lsm_index)
                  enddo
                  ...
                  do i=1, jules50_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n, t,           &
                        LIS_MOC_JULES_STHF,                            &
                        value=jules50_struc(n)%jules50(t)%p_s_sthf(i), &
                        vlevel=i, unit="-", direction="-",             &
                        valid_min=0.0, valid_max=1.0,                  &
                        surface_type=LIS_rc%lsm_index)
                  enddo
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,               &
                     ...
                     value=jules50_struc(n)%jules50(t)%p_s_sthu_min(1), &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,             &
                     ...
                     value=jules50_struc(n)%jules50(t)%p_s_smvccl(1), &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,             &
                     ...
                     value=jules50_struc(n)%jules50(t)%p_s_smvcst(1), &
                     vlevel=1, unit="m^3 m-3", direction="-",         &
                     valid_min=0.0, valid_max=1.0,                    &
                        surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,             &
                     ...
                     value=jules50_struc(n)%jules50(t)%p_s_smvcwt(1), &
                     vlevel=1, unit="m^3 m-3", direction="-",         &
                     valid_min=0.0, valid_max=1.0,                    &
                        surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_EVAP,                              &
                     value=jules50_struc(n)%jules50(t)%fqw_1,   &
                     vlevel=1,unit="kg m-2 s-1",direction="UP", &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n, t,     &
                     LIS_MOC_QH,                              &
                     value=jules50_struc(n)%jules50(t)%ftl_1, &
                     vlevel=1,unit="W m-2",direction="UP",    &
                     surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,         &
                     LIS_MOC_ECANOP,                             &
                     value=jules50_struc(n)%jules50(t)%ecan,     &
                     vlevel=1,unit="kg m-2 s-1", direction="UP", &
                     surface_type=LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n,t,         &
                     LIS_MOC_JULES_ESOIL,                             &
                     value=jules50_struc(n)%jules50(t)%esoil,     &
                     vlevel=1,unit="kg m-2 s-1", direction="UP", &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n,t,       &
                     LIS_MOC_SUBSNOW,                          &
                     value=jules50_struc(n)%jules50(t)%ei,     &
                  ...
                  do i=1, jules50_struc(n)%sm_levels
                     call LIS_diagnoseSurfaceOutputVar(n,t,             &
                        LIS_MOC_SOILET,                                 &
                        vlevel=i,                                       &
                        value=jules50_struc(n)%jules50(t)%ext(i),       &
                  ...
                  !(unit=mm) ***  snow water equivalent 
                  call LIS_diagnoseSurfaceOutputVar(n, t,              &
                      LIS_MOC_SWE,                                     &
                      value =  jules50_struc(n)%jules50(t)%snowdepth(pft) *           &
                               jules50_struc(n)%jules50(t)%rho_snow_grnd(pft),  &
                      vlevel=1, unit="kg m-2", direction="-",                    &
                      surface_type = LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n, t,              &
                      LIS_MOC_WATERTABLED,                             &
                      value = JULES50_struc(n)%jules50(t)%zw,          &
                      vlevel=1, unit="m", direction="-",               &
                      surface_type = LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n,t,                &
                     LIS_MOC_AVGSURFT,                                  &
                     value=jules50_struc(n)%jules50(t)%tstar_tile(pft), &
                     vlevel=1,unit="K",direction="-",                   &
                     surface_type=LIS_rc%lsm_index)

                  !***  surface radiative temperature 
                  ! JULES assumes emissivity to be 1 and trad =  tstar_tile
                  ! Since JULES simulate emissivity, it is not reasonalbe to set trad = tstar_tile
                  ! Shugong Wang 05022018
                  trad = (jules50_struc(n)%jules50(t)%emis_tile(pft)*jules50_struc(n)%jules50(t)%tstar_tile(pft)**4)**0.25 
                  ...
                  lw_upward = sbcon * jules50_struc(n)%jules50(t)%emis_tile(pft) * jules50_struc(n)%jules50(t)%tstar_tile(pft)**4 
                  call LIS_diagnoseSurfaceOutputVar(n, t,                          &
                      LIS_MOC_LWNET,vlevel=1,                                      &
                      value= jules50_struc(n)%jules50(t)%lwdown - lw_upward,       &
                      unit="W m-2", direction="DN", surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_GC,                                &
                     value=jules50_struc(n)%jules50(t)%gc_surft(pft), &
                     vlevel=1,unit="m s-1",direction="-",       &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n,t,LIS_MOC_GS, &
                     value=jules50_struc(n)%jules50(t)%gs_gb,          &
                     vlevel=1,unit="m s-1",direction="-",           &
                     surface_type=LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n,t,LIS_MOC_JULES_STHZW, &
                     value=jules50_struc(n)%jules50(t)%sthzw,          &
                     vlevel=1,unit="-",direction="-",           &
                     surface_type=LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,                 &
                     LIS_MOC_ROUGHNESS,                                  &
                     value=jules50_struc(n)%jules50(t)%p_s_z0_tile(pft), &
                     vlevel=1,unit="m",direction="-",                    &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n,t,                       &
                     LIS_MOC_THERMAL_ROUGHNESS,                                &
                     value=jules50_struc(n)%jules50(t)%p_s_z0_tile(pft) * z0h_z0m(pft), &
                     vlevel=1,unit="m",direction="-",                          &
                     surface_type=LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_QSB,                                             &
                     value = jules50_struc(n)%jules50(t)%sub_surf_roff,       &
                     vlevel=1, unit="kg m-2 s-1", direction="OUT", surface_type = LIS_rc%lsm_index)
                  
                  ! EMK
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_QS,                              &
                     value=jules50_struc(n)%jules50(t)%surf_roff*dt,   &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_QSB,                              &
                     value=jules50_struc(n)%jules50(t)%sub_surf_roff*dt,   &
                     vlevel=1,unit="kg m-2",direction="OUT", &
                     surface_type=LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_QS,                                              &
                     value = jules50_struc(n)%jules50(t)%surf_roff,           &
                     vlevel=1, unit="kg m-2 s-1", direction="OUT", surface_type = LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_QSM,                                             &
                     value = jules50_struc(n)%jules50(t)%snow_melt_gb,        &
                     vlevel=1, unit="kg m-2 s-1", direction="S2L", surface_type = LIS_rc%lsm_index)

                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_DRIP,                                            &
                     value = jules50_struc(n)%jules50(t)%tot_tfall,           &
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_CANOPINT,                                        &
                     value = jules50_struc(n)%jules50(t)%canopy(pft),      &
                     vlevel=1, unit="kg m-2", direction="-", &
                     surface_type = LIS_rc%lsm_index)
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_SWNET,                                           &
                     value= jules50_struc(n)%jules50(t)%sw_tile(pft),         &  
                     vlevel=1,  unit="W m-2", direction="DN", surface_type=LIS_rc%lsm_index)

                  if(pft <= jules50_struc(n)%npft) then  
                    ! vegetation surface types 
                    call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                       LIS_MOC_LAI,                                             &
                       value= jules50_struc(n)%jules50(t)%lai(pft),             &  
                  ...
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_JULES_FSAT,                                             &
                     value= jules50_struc(n)%jules50(t)%fsat,             &  
                     vlevel=1,  unit="-", direction="-", surface_type=LIS_rc%lsm_index)
                  
                  call LIS_diagnoseSurfaceOutputVar(n, t,                     &
                     LIS_MOC_JULES_FWETL,                                             &
                     value= jules50_struc(n)%jules50(t)%fwetl,             &  
                     vlevel=1,  unit="-", direction="-", surface_type=LIS_rc%lsm_index)
...
! EMK BEGIN New output variables
                  ...
                  sfcprs = jules50_struc(n)%jules50(t)%psurf
                  sfctmp = jules50_struc(n)%jules50(t)%tair
                  q2 = jules50_struc(n)%jules50(t)%qair
                  es = 611.0*exp(2.501E6/461.0*(1./273.15 - 1./sfctmp))
                  q2sat = 0.622*es/(sfcprs-(1.-0.622)*es)
                  if (sfctmp .lt. &
                       jules50_struc(n)%jules50(t)%tair_agl_min) then
                     jules50_struc(n)%jules50(t)%tair_agl_min = sfctmp
                     jules50_struc(n)%jules50(t)%rhmin = q2 / q2sat
                  end if

                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_RHMIN,                              &
                     value=jules50_struc(n)%jules50(t)%rhmin,   &
                     vlevel=1,unit="-",direction="-", &
                     surface_type=LIS_rc%lsm_index)
                  call LIS_diagnoseSurfaceOutputVar(n,t,        &
                     LIS_MOC_RHMIN,                              &
                     value=(jules50_struc(n)%jules50(t)%rhmin*100),   &
                     vlevel=1,unit="%",direction="-", &
                     surface_type=LIS_rc%lsm_index)
                  ...
                  if(nsmax .eq.0) then
                    ...
                    call LIS_diagnoseSurfaceOutputVar(n, t,       &
                       LIS_MOC_SNOWICE,                         &
                       value=jules50_struc(n)%jules50(t)%sice(1,1), &
                       vlevel=1, unit="kg m-2", direction="-",    &
                       surface_type=LIS_rc%lsm_index)
                    ! snow liquid water 
                    call LIS_diagnoseSurfaceOutputVar(n, t,       &
                       LIS_MOC_SNOWLIQ,                         &
                       value=jules50_struc(n)%jules50(t)%sliq(1,1), &
                       vlevel=1, unit="kg m-2", direction="-",    &
                       surface_type=LIS_rc%lsm_index)
                    ! snow temperature
                    call LIS_diagnoseSurfaceOutputVar(n, t,       &
                  ...
                  snow_frac = 0.0
                  if(l_aggregate) then
                    if(jules50_struc(n)%jules50(t)%snow_tile(1)+jules50_struc(n)%jules50(t)%snow_grnd(1)>1.0) then
                      snow_frac = 1.0
                    endif
                  else
                    if(jules50_struc(n)%jules50(t)%snow_tile(pft)+jules50_struc(n)%jules50(t)%snow_grnd(pft)>1.0) then
                      snow_frac = jules50_struc(n)%jules50(t)%frac(pft)
                    endif
                  endif
                  ...
                  prcp = jules50_struc(n)%jules50(t)%rainf + jules50_struc(n)%jules50(t)%rainf_c 
                  
                  if (jules50_struc(n)%jules50(t)%tair  .lt. 273.16) then 
                  ...
                  albedo_land = wght_alb(1) * jules50_struc(n)%jules50(t)%land_albedo(1) &
                              + wght_alb(2) * jules50_struc(n)%jules50(t)%land_albedo(2) &
                              + wght_alb(3) * jules50_struc(n)%jules50(t)%land_albedo(3) &
                              + wght_alb(4) * jules50_struc(n)%jules50(t)%land_albedo(4) 
...
!                   !EMK Below code is borrowed from Noah 3.6
                  do i=1, jules50_struc(n)%sm_levels
                     smc = jules50_struc(n)%jules50(t)%smcl_soilt(i)/ &
                          (1000.0*dzsoil(i))
                     smcwilt = jules50_struc(n)%jules50(t)%sm_wilt
                     smcmax = jules50_struc(n)%jules50(t)%sm_sat

DSET ^TARGET_OUTPUT_da/SURFACEMODEL/%y4%m2/LIS_HIST_%y4%m2%d2%h200.d01.nc
DTYPE netcdf
OPTIONS template
UNDEF -9999
...
ZDEF 1 LINEAR 1 1
TDEF 92 LINEAR 00Z02jun2010      1dy
VARS 42
...
Albedo_tavg=>Albedo_tavg 1 y,x description
...
SoilTemp_tavg=>SoilTemp_tavg5 0 4,y,x description
SoilTemp_tavg=>SoilTemp_tavg6 0 5,y,x description
...
EvapSnow_tavg=>EvapSnow_tavg 1 y,x description

...
!   handle synthetic snow water equivalent (SWE) observations. 
!   
! !REVISION HISTORY: 
...
!BOP
! 
! !ROUTINE: syntheticsweobs_setup
! \label{syntheticsweobs_setup}
! 
! !INTERFACE: 
  subroutine syntheticsweobs_setup(k, OBS_State, OBS_Pert_State)
! !USES: 
...
!   creation of data strctures required for SWE assimilation
!  
!   The arguments are: 
!   \begin{description}
...
!EOP
    ...
    call ESMF_ConfigFindLabel(LIS_config,"Synthetic SWE data directory:",&
         rc=status)
    do n=1,LIS_rc%nnest
    ...
    write(LIS_logunit,*)'read Synthetic SWE data specifications'
...
!to obsarr
  ...
  end subroutine syntheticsweobs_setup
  
end module syntheticsweobs_module

...
!EOP
  type, public:: GCOMW_AMSR2L3SND_dec
     ...
     integer, allocatable    :: ims_rlat(:)
     integer, allocatable    :: ims_rlon(:)
     integer, allocatable    :: ims_n11(:)
     integer, allocatable    :: ims_n12(:)
     integer, allocatable    :: ims_n21(:)
     integer, allocatable    :: ims_n22(:)
     integer, allocatable    :: ims_w11(:)
     integer, allocatable    :: ims_w12(:)
     integer, allocatable    :: ims_w21(:)
     integer, allocatable    :: ims_w22(:)

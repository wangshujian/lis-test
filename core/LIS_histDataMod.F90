...
!  14 Mar 2014    David Mocko: Added CAPE, CRAINFORC, CMFORC, and CHFORC outputs
...
#if 0 
  !SAC/SNOW17
  public :: LIS_MOC_SACQS
  public :: LIS_MOC_SACQSB
  public :: LIS_MOC_SACSWE
  public :: LIS_MOC_SACPOTEVAP
  public :: LIS_MOC_SACEVAP
  !public :: LIS_MOC_SACSOILMOIST1
  public :: LIS_MOC_SACSOILMOIST2
  !public :: LIS_MOC_SACSOILMOIST3
  public :: LIS_MOC_SACSOILMOIST4
  public :: LIS_MOC_SACSOILMOIST5
  !public :: LIS_MOC_SACSOILMOIST6
  public :: LIS_MOC_SACSOILTEMP1
  public :: LIS_MOC_SACSOILTEMP2
  public :: LIS_MOC_SACSFRAC
  public :: LIS_MOC_SACSDEPTH
  public :: LIS_MOC_SACUZTWM
  public :: LIS_MOC_SACUZFWM
  public :: LIS_MOC_SACLZTWM
  public :: LIS_MOC_SACLZFSM
  public :: LIS_MOC_SACLZFPM
  public :: LIS_MOC_SACADIMP
  public :: LIS_MOC_SACRAINF
  public :: LIS_MOC_SACTAIR

  public :: LIS_MOC_SNOW17TWE

  public :: LIS_MOC_SNOW17SWEINCR
  public :: LIS_MOC_SNOW17WEINCR
  public :: LIS_MOC_SNOW17TWEINCR
  public :: LIS_MOC_SNOW17SFRAC1

  public :: LIS_MOC_SNOW17DS
  public :: LIS_MOC_SNOW17AESCINCR
  public :: LIS_MOC_SNOW17CNHS
  public :: LIS_MOC_SNOW17SFRAC4

  public :: LIS_MOC_SNOW17SFRAC6
  public :: LIS_MOC_SNOW17SFRAC7
  public :: LIS_MOC_SNOW17SFRAC8
  public :: LIS_MOC_SNOW17SFRAC9
  public :: LIS_MOC_SNOW17SFRAC10
  public :: LIS_MOC_SNOW17SFRAC11
  public :: LIS_MOC_SNOW17SFRAC12
  public :: LIS_MOC_SNOW17SFRAC13
  public :: LIS_MOC_SNOW17SFRAC14
  public :: LIS_MOC_SNOW17SFRAC15
  public :: LIS_MOC_SNOW17RAINF
  public :: LIS_MOC_SNOW17SNOWF
  public :: LIS_MOC_SNOW17TAIR

  public :: LIS_MOC_SNOW17RMINCR
#endif
!</for vic>
...
! NLDAS
  ...
  integer :: LIS_MOC_LAYERSNOWDENSITY = -9999
   ...
   integer :: LIS_MOC_RAINFCONV = -9999
...
!</for vic>
   ...
   integer :: LIS_MOC_SACQS             = -9999
   integer :: LIS_MOC_SACQSB            = -9999
   integer :: LIS_MOC_SACSWE            = -9999
   integer :: LIS_MOC_SACPOTEVAP        = -9999
   integer :: LIS_MOC_SACEVAP           = -9999
   integer :: LIS_MOC_SACUZTWC          = -9999
   integer :: LIS_MOC_SACUZFWC          = -9999
   integer :: LIS_MOC_SACLZTWC          = -9999
   integer :: LIS_MOC_SACLZFSC          = -9999
   integer :: LIS_MOC_SACLZFPC          = -9999
   integer :: LIS_MOC_SACADIMPC         = -9999
   !integer :: LIS_MOC_SACSOILMOIST1     = -9999
   integer :: LIS_MOC_SACSOILMOIST2     = -9999
   !integer :: LIS_MOC_SACSOILMOIST3     = -9999
   integer :: LIS_MOC_SACSOILMOIST4     = -9999
   integer :: LIS_MOC_SACSOILMOIST5     = -9999
   !integer :: LIS_MOC_SACSOILMOIST6     = -9999
   integer :: LIS_MOC_SACSOILTEMP1      = -9999
   integer :: LIS_MOC_SACSOILTEMP2      = -9999
   integer :: LIS_MOC_SACSFRAC          = -9999
   integer :: LIS_MOC_SACSDEPTH         = -9999
   integer :: LIS_MOC_SACUZTWM          = -9999
   integer :: LIS_MOC_SACUZFWM          = -9999
   integer :: LIS_MOC_SACLZTWM          = -9999
   integer :: LIS_MOC_SACLZFSM          = -9999
   integer :: LIS_MOC_SACLZFPM          = -9999
   integer :: LIS_MOC_SACADIMP          = -9999
   integer :: LIS_MOC_SACRAINF          = -9999
   integer :: LIS_MOC_SACTAIR           = -9999
   integer :: LIS_MOC_SNOW17SWE         = -9999
   integer :: LIS_MOC_SNOW17TWE         = -9999
   integer :: LIS_MOC_SNOW17AEADJ       = -9999
   integer :: LIS_MOC_SNOW17SWEINCR     = -9999
   integer :: LIS_MOC_SNOW17WEINCR      = -9999
   integer :: LIS_MOC_SNOW17TWEINCR     = -9999
   integer :: LIS_MOC_SNOW17SFRAC1      = -9999
   integer :: LIS_MOC_SNOW17NEGHS       = -9999
   integer :: LIS_MOC_SNOW17LIQW        = -9999
   integer :: LIS_MOC_SNOW17DS          = -9999
   integer :: LIS_MOC_SNOW17AESCINCR    = -9999
   integer :: LIS_MOC_SNOW17CNHS        = -9999
   integer :: LIS_MOC_SNOW17SFRAC4      = -9999
   integer :: LIS_MOC_SNOW17ACCMAX      = -9999
   integer :: LIS_MOC_SNOW17SFRAC6      = -9999
   integer :: LIS_MOC_SNOW17SFRAC7      = -9999
   integer :: LIS_MOC_SNOW17SFRAC8      = -9999
   integer :: LIS_MOC_SNOW17SFRAC9      = -9999
   integer :: LIS_MOC_SNOW17SFRAC10     = -9999
   integer :: LIS_MOC_SNOW17SFRAC11     = -9999
   integer :: LIS_MOC_SNOW17SFRAC12     = -9999
   integer :: LIS_MOC_SNOW17SFRAC13     = -9999
   integer :: LIS_MOC_SNOW17SFRAC14     = -9999
   integer :: LIS_MOC_SNOW17SFRAC15     = -9999
   integer :: LIS_MOC_SNOW17RAINF       = -9999
   integer :: LIS_MOC_SNOW17SNOWF       = -9999
   integer :: LIS_MOC_SNOW17TAIR        = -9999
   integer :: LIS_MOC_SNOW17RMLT        = -9999
   integer :: LIS_MOC_SNOW17RMINCR      = -9999
#endif
!<for vic>
...
!-------------------------------------------------------------------------
  !!! JULES
    ...
    if ( rc == 1 ) then
       call register_dataEntry(LIS_MOC_LSM_COUNT,LIS_MOC_RAINFCONV,&
            LIS_histData(n)%head_lsm_list,&
            n,2,ntiles,(/"kg/m2s","kg/m2 "/),&
            2,(/"UP","DN"/),2,1,1,&
            model_patch=.true.)

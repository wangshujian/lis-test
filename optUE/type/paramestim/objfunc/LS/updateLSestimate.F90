...
!  write(LIS_logunit,*) '[INFO] Here 1 in updateLSestimate:', sqerr
...
!  write(LIS_logunit,*) '[INFO] Here 2 in updateLSestimate:', numobs 
  ...
  do k=1, ls_ctl%nobjs
!     write(LIS_logunit,*) '[INFO] Here 3 in updateLSestimate:', ls_ctl%obj_name(k) 
...
!     write(LIS_logunit,*) '[INFO] Here 3a in updateLSestimate:', peobs 
     ...
     call LIS_verify(status)
!     write(LIS_logunit,*) '[INFO] Here 3b in updateLSestimate:', obspred 
...
!  write(LIS_logunit,*) '[INFO] Finished updateLSestimate, sqerr:', sqerr, ', numobs:', numobs 
...
!  write(LIS_logunit,*) '[INFO] Finished updateLSestimate'
